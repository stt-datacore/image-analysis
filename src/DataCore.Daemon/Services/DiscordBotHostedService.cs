...
namespace DataCore.Daemon
{
    public class DiscordBotHostedService : IHostedService, IDisposable
    {
        ...
        public async Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            _discordHelper = new DiscordHelper(_config["DATACORE_WEB"], _config["DISABLED_GUILDS"].Split(';'), _logger, _searcher.Searcher, _searcher.VoyImage, _crewData.BotHelper, _config["bot:IMGFLIP_PASSWORD"]);
